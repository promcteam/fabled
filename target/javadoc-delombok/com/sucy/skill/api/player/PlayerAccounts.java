...
public class PlayerAccounts {
    ...
    public HashMap<Integer, PlayerData> getAllData() {
        return _accounts.getAllData().entrySet().stream().collect(Collectors.toMap(Map.Entry::getKey, e -> new PlayerData(e.getValue()), (a, b) -> a, HashMap::new));
    }
    ...
    @lombok.Generated
    public PlayerAccounts(final studio.magemonkey.fabled.api.player.PlayerAccounts _accounts) {
