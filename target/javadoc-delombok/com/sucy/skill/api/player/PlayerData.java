...
public class PlayerData {
    ...
    public Collection<PlayerSkill> getSkills() {
        return _data.getSkills().stream().map(PlayerSkill::new).collect(Collectors.toList());
    }
    ...
    @lombok.Generated
    public PlayerData(final studio.magemonkey.fabled.api.player.PlayerData _data) {
        this._data = _data;
    }
}
