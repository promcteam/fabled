...
public class ShieldDetails {
    ...
    public void update() {
        effects.removeIf(shieldEffect -> {
            if (shieldEffect.isExhausted()) {
                if (getEntity() instanceof Player) shieldEffect.display((Player) getEntity());
    ...
    private class ShieldTask implements Runnable {
        ...
        @lombok.Generated
        public ShieldTask(final ShieldEffect effect) {
            this.effect = effect;
        }
    }
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public ShieldDetails(final UUID uniqueId) {
    ...
    @java.lang.SuppressWarnings("all")
    @lombok.Generated
    public void setDisplayTask(final BukkitTask displayTask) {
