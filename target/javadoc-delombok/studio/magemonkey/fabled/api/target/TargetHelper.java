...
public abstract class TargetHelper {
    ...
    public static boolean isSolid(Material mat) {
        ...
        // This is where we'd make special accommodations for things like doors or trapdoors if need be.
    }
    ...
    public static double getHeight(Entity entity) {
        return (PluginChecker.isDisguiseActive() && DisguiseAPI.isDisguised(entity))
                ? DisguiseHook.getFakeBoundingBox(entity).getY()
                : entity.getHeight();
    }
}