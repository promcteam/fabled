...
[![Build](https://github.com/magemonkeystudio/fabled/actions/workflows/devbuild.yml/badge.svg?branch=dev)](https://s01.oss.sonatype.org/content/repositories/snapshots/studio/magemonkey/fabled/1.0.4-R0.45-SNAPSHOT/)
...
<dependency>
    ...
    <version>1.0.4-R0.45-SNAPSHOT</version>
</dependency>
```
